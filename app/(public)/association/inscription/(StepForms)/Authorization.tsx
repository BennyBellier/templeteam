...
export default function Authorization() {
  ...
  const undersigner = () => {
    if (calculateAge(store.member?.birthdate!) >= 18) {
      return (
        <SelectItem
          value={store.member?.lastname + " " + store.member?.firstname}
        >
    ...
    return store.legalGuardians?.map((legalGuardian, index) => (
      <SelectItem
        key={legalGuardian.phone}
        value={legalGuardian.lastname + " " + legalGuardian.firstname}
      >
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className={labelClassName}>
                ...
                >
                  autorise les responsables de l&apos;association à prendre, en
                  son nom, toutes les décisions nécessaires en cas
                  d&apos;urgence, notamment pour des raisons médicales ou autres
                  situations critiques, afin d&apos;assurer sa sécurité et son
                  bien-être.
                </Typography>
              </FormLabel>
              <FormMessage />
            ...
            <FormItem>
              <FormLabel className={labelClassName}>
                ...
                <Typography
                  ...
                  className="col-start-2 row-start-2 max-w-[500px]"
                >
                  autorise l&apos;association à organiser ses déplacements dans
                  des véhicules privés mis à disposition par l&apos;association
                  ou appartenant aux responsables, si cela s&apos;avère
                  nécessaire pour les activités.
                </Typography>
              </FormLabel>
              <FormMessage />
            </FormItem>
            ...
            <FormItem>
              <FormLabel className={labelClassName}>
                ...
                <Typography
                  ...
                  className="col-start-2 row-start-2 max-w-[500px]"
                >
                  autorise l&apos;association à utiliser et publier des photos,
                  vidéos, et tout autre support visuel ou document le
            ...
            <FormItem>
              <FormLabel className={labelClassName}>
                ...
                >
                  ...
                  bijoux ou autres biens de valeur m&apos;appartenant, lors des
                  entraînements, compétitions ou autres événements organisés par
                  l&apos;association.
                </Typography>
              </FormLabel>
              <FormMessage />
            ...
            <FormItem>
              <FormLabel className={labelClassName}>
                ...
                >
                  ...
                  l&apos;association et s&apos;engage à en respecter toutes les
                  dispositions.
                </Typography>
              </FormLabel>
              <FormMessage />
